...
''' The region which sold the highest price of avocado in average is HartfordSpringfield (1.818639).'''
...
biggest = lot.sort_values(by = 'Total Volume', ascending = [True])
'''In the NorthernNewEngland , the biggest lot of sold avocado came from 4225 (5.36093e+07)'''
...
#5
df['Number_of_Avocado'] = df['4046']/4 + df['4225']/9 + df['4770']/12
avocado_number = df.groupby(['region'])[['Number_of_Avocado']].sum()
